...
export default defineComponent({
    ...
    setup() {
        ...
        const getScoreDescription = (score) => {
            if (score >= 70)
                return 'This cryptocurrency appears to be Shariah-compliant';
            if (score >= 50)
                return 'This cryptocurrency requires further analysis';
            return 'This cryptocurrency may not be Shariah-compliant';
        };
        const checkCompliance = async () => {
            if (!cryptoSymbol.value)
                return;
            loading.value = true;
            error.value = null;
            try {
...
const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({
    ...{ 'onKeyup': {} },
    modelValue: (__VLS_ctx.cryptoSymbol),
...
const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({
    ...
    disabled: (!__VLS_ctx.isValid || !__VLS_ctx.cryptoSymbol),
    block: true,
    ...{ class: "mb-4" },
}));
...
var __VLS_12;
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['crypto-checker']} */ ;
