...
export default defineComponent({
    ...
    setup() {
        ...
        const getScoreDescription = (score) => {
            if (score >= 70)
                return 'This ETF appears to be Shariah-compliant';
            if (score >= 50)
                return 'This ETF requires further analysis';
...
const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({
    ...{ 'onKeyup': {} },
    modelValue: (__VLS_ctx.etfSymbol),
    label: "Enter ETF Symbol (e.g. SPUS)",
    rules: ([(v) => !!v || 'ETF symbol is required']),
    ...{ class: "mb-4" },
    clearable: true,
...
const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({
    ...
    disabled: (!__VLS_ctx.isValid || !__VLS_ctx.etfSymbol),
    block: true,
    ...{ class: "mb-4" },
}));
...
var __VLS_12;
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['etf-checker']} */ ;
